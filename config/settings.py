...
if os.getenv("POSTGRES_HOST"):
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "mailings"),
            "USER": os.getenv("POSTGRES_USER", "mailings"),
            "PASSWORD": os.getenv("POSTGRES_PASSWORD", "mailings"),
...
LOGGING = {
    ...
    "loggers": {"mailings.delivery": {"handlers": ["console"], "level": "INFO", "propagate": False}},
}
